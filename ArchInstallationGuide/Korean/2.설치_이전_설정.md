...
**부팅 이후**
- 부팅 이후 아치 리눅스 설치 미디어의 부트로더 화면이 나온다.
![archiso_bootloader.png](./Sources/archiso_bootloader.png)
- Enter 를 눌러 Boot Arch Linux 를 선택한다.

```
root@archiso ~ # 
```
![archiso](./Sources/archiso.png)
- 설치 미디어로 부팅한 이후 다음과 같이 아치 리눅스 인스톨러의 콘솔 창이 뜬다.
